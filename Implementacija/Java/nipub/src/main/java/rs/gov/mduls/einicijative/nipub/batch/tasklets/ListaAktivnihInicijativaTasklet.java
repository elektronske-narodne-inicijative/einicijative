...
public class ListaAktivnihInicijativaTasklet implements Tasklet, InitializingBean {

    private static final Logger logger = LoggerFactory.getLogger(ListaAktivnihInicijativaTasklet.class);
    @Autowired
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        logger.info("Објава листе активних иницијатива...");
