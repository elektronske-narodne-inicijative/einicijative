...
public class NaslovnaStatistikeTasklet implements Tasklet, InitializingBean {

    private static final Logger logger = LoggerFactory.getLogger(NaslovnaStatistikeTasklet.class);
    @Autowired
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        logger.info("Објава статистика за насловну страну...");
