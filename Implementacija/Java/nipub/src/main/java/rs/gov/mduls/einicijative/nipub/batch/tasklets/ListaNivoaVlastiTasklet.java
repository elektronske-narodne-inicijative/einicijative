...
public class ListaNivoaVlastiTasklet implements Tasklet, InitializingBean {

    private static final Logger logger = LoggerFactory.getLogger(ListaNivoaVlastiTasklet.class);
    @Autowired
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        logger.info("Објава листе нивоа власти...");
