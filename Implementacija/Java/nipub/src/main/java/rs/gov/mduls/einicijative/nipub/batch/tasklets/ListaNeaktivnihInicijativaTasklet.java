...
public class ListaNeaktivnihInicijativaTasklet implements Tasklet, InitializingBean {

    private static final Logger logger = LoggerFactory.getLogger(ListaNeaktivnihInicijativaTasklet.class);
    @Autowired
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        logger.info("Објава листе неактивних иницијатива...");
