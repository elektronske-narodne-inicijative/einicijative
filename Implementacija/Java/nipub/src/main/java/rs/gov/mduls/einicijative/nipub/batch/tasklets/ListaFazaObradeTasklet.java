...
public class ListaFazaObradeTasklet implements Tasklet, InitializingBean {

    private static final Logger logger = LoggerFactory.getLogger(ListaFazaObradeTasklet.class);
    @Autowired
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        logger.info("Објава листе фаза обраде...");
