        ...
        <div class="grid dashboard-grid">
            ...
            <div class="col-12 md:col-6 overview-box ukratko">
                <div class="card">
                    ...
                    <p>&nbsp;</p>
                    <p>Овај сајт, у спрези са другим сервисима државних органа Србије, омогућава електронско покретање и потписивање народних иницијатива.</p>
                    <p>&nbsp;</p>
                    <p style="color: darkred"><i>*** Ова рана демо верзија сајта користи (осим у цитираним члановима закона изнад) женски род као неутрални/заједнички, као малу показну вежбу родне асиметричности језика. *** </i></p>
                </div>
            </div>
        </div>
    </div>
