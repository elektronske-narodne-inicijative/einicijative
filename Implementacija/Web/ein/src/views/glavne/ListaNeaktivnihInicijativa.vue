        ...
        <div class="col-12">
            <div class="card">
                ...
                >
                    ...
                    <Column field="brPotpisa" header="Бр. Потписа" style="min-width: 3rem" bodyStyle="text-align:right" sortable>
                        <template #body="{ data }">
                            {{ formatNumber(data.brPotpisa) }}
                        </template>
                    </Column>

                    <Column field="nazivInicijative" header="Назив" style="min-width: 25rem" sortable filter>
                        <template #body="{ data }">
